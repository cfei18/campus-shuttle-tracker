...
public class RSSHandler extends DefaultHandler 
{
    ...
    final int RSS_GEORSS_POINT = 6;
    final int RSS_SPEED = 7;
    final int RSS_DIRECTION = 8;
                                             ...
                                             Attributes atts) throws SAXException
    {
        ...
        {
        	currentstate = RSS_GEORSS_POINT;
        	return;
        }
        if (localName.equals("speed"))
        {
        	currentstate = RSS_SPEED;
        	return;
        }
        if (localName.equals("direction")) 
        {
        	currentstate = RSS_DIRECTION;
        	return;
        }
    ...
    public void characters(char ch[], int start, int length)
    {
        ...
        switch (currentstate)
        {
            ...
            case RSS_PUBDATE:
                ...
                break;
            case RSS_DIRECTION:
            	_item.setDirection(theString);
            	currentstate = 0;
            	break;
            case RSS_SPEED:
            	_item.setSpeed(theString);
            	currentstate = 0;
            	break;
            case RSS_GEORSS_POINT:
            	_item.setPoint(theString);
            	currentstate = 0;
            	break;
            default:
                return;
